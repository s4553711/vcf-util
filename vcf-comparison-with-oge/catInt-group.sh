...
grep '^#' .venn/int_${name1}_${name2}_${name3}_1_${event}.vcf > .venn/data/${name1}_${name2}_${name3}.int.${event}.vcf
for chrosome in $chrs; do
	cat .venn/int_${name1}_${name2}_${name3}_${chrosome}_${event}.vcf | grep -v '#' >> .venn/data/${name1}_${name2}_${name3}.int.${event}.vcf
done
touch ".venn/end"
