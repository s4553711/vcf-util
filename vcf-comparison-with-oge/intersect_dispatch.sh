...
echo "${Vcfintersect} -i .venn/${name1}.${region}.decomplx.brk.decomplx.vcf .venn/${name2}.${region}.decomplx.brk.decomplx.vcf -r ${Ref} > .venn/int_${name1}_${name2}_${region}_${event}.vcf"
